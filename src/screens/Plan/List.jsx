...
import { BottomSheetModal, RouteSelected, CustomDatePicker, Icon, RouteCard } from "@/components";
...
const List = ({ navigation, route }) => {
  ...
  return (
    <>
      ...
      <BottomSheetModal bottomSheetStyle={{ flex: 1, backgroundColor: "#f2f2f2" }}>
...
// vista de resultado de bsuqueda
    ...
    <View style={styles.containerModal}>
      ...
      <View style={styles.optionsModal}>
        ...
        <View style={styles.optionTransportModal}>
          <View style={[styles.borderIconModal, { backgroundColor: "#F5F5F5", padding: 3 }]}>
